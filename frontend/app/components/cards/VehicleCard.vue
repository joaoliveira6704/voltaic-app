...
<template>
    <div
        class="relative hover:bg-green-600/20 h-30 transition-all duration-300 w-60 bg-neutral-200 rounded-xl p-5 gap-2 flex flex-col justify-between font-mono group"
    >
        <!-- <Pencil
      @click="emit('edit')"
    ...
    ></Pencil> -->
        ...
        <div class="flex flex-col content-center items-start gap-3">
            <span
                class="text-md font-black uppercase text-neutral-800 line-clamp-1 h-12 mt-2"
            >
                {{ props.data.model }}
            </span>
            ...
            <div class="flex gap-2 items-center">
                ...
                >
                    ...
                    <span
                        class="text-sm font-bold text-neutral-800 tracking-wider"
                    >
                        {{ props.data.plate }}
                    </span>
                </div>
