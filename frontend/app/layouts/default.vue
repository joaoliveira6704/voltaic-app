...
import { Map, Menu, SidebarIcon } from "lucide-vue-next";
import {
    Sheet,
    SheetContent,
    SheetTitle,
...
<template>
    ...
    >
        <nav
            class="block md:hidden shrink-0 w-full border-b border-gray-100 bg-white dark:bg-[#0a0a0a] dark:text-white dark:border-[#232323]"
        >
            <div
